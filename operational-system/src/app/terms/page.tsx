      ...
      <main className="max-w-3xl mx-auto px-5 md:px-8 py-16 md:py-24">
        ...
        <div className="prose prose-invert prose-sm md:prose-base max-w-none space-y-10 text-white/75 leading-relaxed">
          ...
          <section>
            ...
            <p>
              האתר מציע שאלון אבחון ניהולי חינמי המפיק דוח מותאם אישית, ושיחת אסטרטגיה תפעולית בתשלום של כשעה (350 ש&quot;ח),
              שבסופה נמסר תוצר כתוב. הסכום מקוזז במלואו מפרויקט המשך, אם יוזמן.
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>התחייבות ערך: אם בתום השיחה הלקוחה סבורה שלא קיבלה ערך אמיתי — יינתן החזר כספי מלא.</li>
            </ul>
          </section>
