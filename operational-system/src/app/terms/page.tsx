...
export const metadata: Metadata = {
  title: 'תנאי שימוש – Architecture of Scale',
  description: 'תנאי השימוש של האתר והשירותים של Architecture of Scale / הדר אוטומציות.',
};
      ...
      <main className="max-w-3xl mx-auto px-5 md:px-8 py-16 md:py-24">
        ...
        <div className="prose prose-invert prose-sm md:prose-base max-w-none space-y-10 text-white/75 leading-relaxed">
          ...
          <section>
            ...
            <p>
              השימוש באתר ובשאלון האבחון של <strong className="text-white">Architecture of Scale / הדר אוטומציות</strong> מהווה הסכמה לתנאים המפורטים להלן.
