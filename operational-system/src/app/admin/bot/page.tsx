  ...
  return (
    <div className="space-y-6 p-6 md:p-8" dir="rtl">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900">WhatsApp Bot</h1>
          <p className="text-sm text-gray-500 mt-0.5">ניטור סוכן המכירות</p>
        </div>
      </div>
      ...
      <Tabs defaultValue="events" dir="rtl">
        <TabsList className="mb-4">
          ...
          <TabsTrigger value="config">הגדרות בוט</TabsTrigger>
        </TabsList>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-500">50 אחרונים</span>
              </div>
              <div className="flex items-center gap-3">
