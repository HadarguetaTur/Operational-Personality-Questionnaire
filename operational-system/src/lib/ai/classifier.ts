...
6. new_facts: מידע חדש שנאמר בהודעה זו בלבד (לא מה שכבר ידוע מה-context).
   קיים:
   - name: השם הפרטי שלה אם הציגה את עצמה ("קוראים לי מיכל", "אני רותם"). לעולם אל תחזיר "הדר" או "הדר אוטומציות" כשם הלקוחה — זהו שם בעלת העסק/העסק, לא שם הלקוחה, גם אם הלקוחה הזכירה אותו ("שמעתי על הדר", "רוצה לעבוד עם הדר").
