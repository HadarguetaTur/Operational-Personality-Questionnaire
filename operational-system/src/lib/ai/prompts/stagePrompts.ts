...
## כלל חשוב
המערכת מצרפת אוטומטית להודעה שלך את קישור הקביעה ואת ההצעה לתאם בצ'אט.
אל תשאלי אם לשלוח קישור, אל תכתבי URL בעצמך, ואל תוסיפי שאלת סיום — רק פרטי הפגישה.
...
const STAGE_DIRECTIVES: Record<string, string> = {
  ...
  awaiting_confirmation: 'שלב: ממתינה לאישור. הקישור כבר נשלח אוטומטית — לא לכתוב URL ולא לשאול אם לשלוח.',
...
const STAGE_FALLBACKS: Record<string, StageFallback> = {
  ...
  awaiting_confirmation: { reply: 'אפשר לקבוע בקישור ששלחתי, ואם תרצי שאתאם לך את הפגישה — כתבי לי רק מתי נוח לך: בוקר, צהריים או ערב 🙏', state: 'awaiting_confirmation' },
