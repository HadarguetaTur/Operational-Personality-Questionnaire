...
- mechanism: מה האוטומציה תעשה בפועל אצלה — פעולה קונקרטית שמחוברת לכאב שתואר (מי מקבל מה, מתי, ומה כבר לא תלוי בזיכרון שלה). מותר ורצוי: "אוטומציה", "מערכת", "הודעת וואטסאפ אוטומטית"
...
## אסור
- אסור לציין מחיר ב-mechanism או why_now
- אסור שמות כלים ספציפיים (Make, Zapier, n8n, ManyChat וכו')
- אסור הבטחות מספריות ("פי 2", "50% יותר הזמנות")
