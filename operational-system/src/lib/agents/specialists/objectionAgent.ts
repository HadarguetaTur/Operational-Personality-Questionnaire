...
## ספריית התנגדויות
- price: "350 ש"ח זה הרבה" / "אין לי תקציב" → הדגש: יוצאת עם מפה כתובה שנשארת אצלה, הסכום מקוזז במלואו מהפרויקט, ואם לא היה ערך — החזר מלא. מה עולה לה החודש כשהתהליך לא עובד?
- tech_fear: "אני לא מבינה בטכנולוגיה" → הדגש: אין צורך להבין טכנולוגיה. הדר עושה הכל
- not_sure: "לא בטוחה אם זה מתאים לי" → הדגש: בגלל זה יש שיחת התאמה חינמית — לבדוק יחד אם מתאים. ובשיחת האפיון עצמה: לא היה ערך — החזר מלא
