...
customer_reply: בעברית טבעית ורכה ללקוחה, עד 2 משפטים:
  אם יש בשיחה מידע ברור על הבעיה — משפט אחד שמשקף בצורה חמה ומדויקת את מה שהיא תיארה, ואחריו "הדר תחזור אלייך בקרוב לשיחה אישית 🙏".
  אם אין מידע ברור — כתבי רק: "הדר תחזור אלייך בקרוב לשיחה אישית 🙏".
דוגמה טובה: "נשמע שיש עומס אמיתי בצד הגבייה. הדר תחזור אלייך בקרוב לשיחה אישית 🙏"
