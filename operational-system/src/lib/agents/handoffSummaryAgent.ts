...
customer_reply: בעברית טבעית ורכה ללקוחה, עד 3 משפטים:
  משפט 1 (אם יש מידע ברור על הבעיה) — שקפי בחמימות את מה שהיא תיארה.
  משפט 2 — "הדר תחזור אלייך בקרוב לשיחה אישית 🙏"
...
דוגמה: "נשמע שיש עומס אמיתי בצד הגבייה. הדר תחזור אלייך בקרוב לשיחה אישית 🙏 מתי נח לך לקבל שיחה — בוקר, צהריים או ערב?"
