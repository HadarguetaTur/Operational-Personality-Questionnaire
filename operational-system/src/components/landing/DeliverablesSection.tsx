...
import { LandingCopy, getPaymentUrl, DELIVERABLES_MICROCOPY } from '@/config/landingCopy';
                ...
                return (
                  <li key={i}>
                    <div className="deliverable-item-glass flex gap-4 items-center p-4 rounded-xl text-right">
                      ...
                      <span className="text-white/95 text-base md:text-[16px] leading-relaxed font-medium">{d}</span>
                    </div>
                  </li>
                );
              })}
            </ul>
            <p className="mt-6 text-white/70 text-base leading-relaxed text-right">{DELIVERABLES_MICROCOPY}</p>
