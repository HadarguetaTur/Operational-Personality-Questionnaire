            ...
            <div className="relative">
              ...
              <div className="space-y-6 md:space-y-8">
                {copy.processSteps.map((step, i) => {
                  ...
                  return (
                    <div key={i} className="process-step-reveal flex gap-4 md:gap-6 items-start">
                      <div className="process-step-circle">
                        <span className="text-[var(--landing-primary)] font-bold text-lg">{i + 1}</span>
                      </div>
                      <div className="process-step-card flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <h3 className="text-white font-bold text-base md:text-lg leading-snug">{step.title}</h3>
                        </div>
                        <p className="text-white/75 text-sm md:text-base leading-relaxed mr-8">{step.description}</p>
                      </div>
                    </div>
                  );
                })}
