              ...
              {photoSrc && (
                <div className="shrink-0 relative mx-auto md:mx-0">
                  ...
                  <div className="photo-blob-frame relative overflow-hidden border-2 border-white/10 shadow-2xl">
                    ...
                    <img src={photoSrc} alt="תמונה אישית" className="w-44 h-44 md:w-52 md:h-52 object-cover" />
                  </div>
                </div>
              )}
              <div className="flex-1 min-w-0">
                <p className="text-base md:text-[17px] text-white/90 mb-6 leading-relaxed">{copy.whyMeIntro}</p>
                ...
                <p className="text-base font-medium text-white/90 leading-relaxed">{copy.whyMeClose}</p>
              </div>
            </div>
          </div>
        </div>
