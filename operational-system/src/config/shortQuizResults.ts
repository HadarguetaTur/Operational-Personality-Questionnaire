...
export const SCOPING_CALL_PROMISE = {
  plan: 'שיחת ההיכרות קצרה, בלי עלות ובלי מחויבות. היא נועדה רק להבין אם יש התאמה ומה כדאי לסדר ראשון.',
  price:
...
export const SCOPING_CALL_BRIDGE =
  'את כבר רואה איפה זה דולף. הצעד הבא הוא לא עוד טיפ כללי, אלא שיחת היכרות קצרה איתי, בלי עלות, להבין אם זה משהו שכדאי לסדר עכשיו, ומה הדבר הראשון.';
