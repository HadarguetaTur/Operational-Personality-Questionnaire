...
export const HOME_FAQ_INTRO = "תשובות קצרות על המחשבון, על מה שמקבלים, ועל מה שקורה אחרי.";
...
/** שאלות FAQ משותפות — מחשבון "איפה הכסף?" */
export const SHARED_FAQ: FaqItem[] = [
  {
    question: "האם המחשבון באמת חינמי?",
    answer:
      "כן. עונים על 10 שאלות קצרות ומקבלים הערכה ראשונית לפי התחומים המרכזיים בעסק. לא צריך כרטיס אשראי.",
  },
  {
    question: "האם צריך לדעת מספרים מדויקים?",
    answer:
      "לא. הערכות גסות מספיקות. אם חסר נתון, המחשבון משתמש בהנחות שמרניות ומציג זאת בתוצאה.",
  },
  {
    question: "האם זו הבטחה לחיסכון?",
    answer:
      "לא. זו הערכה ראשונית בלבד, לא דוח חשבונאי ולא הבטחה לתוצאה. המטרה היא להבין איפה כדאי להתחיל לעשות סדר.",
  },
  {
    question: "מה מקבלים בסוף?",
    answer:
      "הערכת עלות לפי תחומים, פוטנציאל התייעלות ראשוני, והמלצה מאיפה כדאי להתחיל לסדר את התהליך.",
  },
  {
    question: "למה צריך להשאיר פרטים?",
    answer:
      "כדי לשלוח את הסיכום המותאם לפי התוצאה שלך. המחשבון עצמו קצר, והסיכום עוזר להבין מה לעשות עם המספרים.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "אם אין לך עדיין פניות או לקוחות פעילים, המחשבון כנראה פחות רלוונטי כרגע. הוא מיועד לעסק שכבר זז, אבל רוצה להבין איפה הזמן והכסף נתקעים.",
  },
];
...
export const HOME_ABOUT_SECTION: WhyMeSectionCopy = {
  ...
  whyMeClose:
    "המחשבון 'איפה הכסף?' נבנה בדיוק בשביל זה: לפני שבונים מערכת, לראות איפה הניהול הידני באמת עולה זמן וכסף. המטרה היא לא עוד אוטומציה, אלא סדר שמחזיק.",
};
