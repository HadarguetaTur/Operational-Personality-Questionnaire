...
export const SHARED_FAQ: FaqItem[] = [
  {
    ...
    answer:
      "כן. עונים על 10 שאלות קצרות ומקבלים תמונה אישית לפי התחומים המרכזיים בעסק. לא צריך כרטיס אשראי.",
  },
  {
    question: "וכמה עולה ההמשך, אם ארצה?",
    answer:
      "שקוף מראש: אחרי הבדיקה אפשר לקבוע שיחת אסטרטגיה של 350 ש\"ח, שבסופה יוצאים עם מפת אוטומציה כתובה שנשארת אצלך. הסכום מקוזז במלואו מהפרויקט אם ממשיכות יחד, ופרויקטים מלאים נעים לרוב בין 5,000 ל-15,000 ש\"ח. אין הפתעות בהמשך הדרך.",
  },
  {
    question: "אין לי זמן לעוד דבר עכשיו",
    answer:
      "בדיוק בגלל זה הבדיקה קצרה: 10 שאלות, כ-3 דקות, בלי הכנה. והיא עוסקת בדיוק בשעות שהתפעול הידני גוזל לך כל שבוע. שלוש דקות שמראות איפה הזמן שלך הולך.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "אפשר ליישם לבד את הצעדים הראשונים, או לקבוע שיחת אסטרטגיה ממוקדת כדי להחליט איזה תהליך הכי נכון לבנות קודם. השיחה בתשלום של 350 ש\"ח, מקוזז במלואו מהפרויקט אם ממשיכות, ואם לא היה ערך יש החזר מלא.",
  },
  {
