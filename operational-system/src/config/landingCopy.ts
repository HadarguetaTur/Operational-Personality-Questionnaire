...
/** שאלות FAQ משותפות — שאלון הקצר (6 שאלות, וואטסאפ) */
export const SHARED_FAQ: FaqItem[] = [
  {
    question: "האם הבדיקה באמת חינמית?",
    answer:
      "לחלוטין. לא צריך כרטיס אשראי ולא שום פרטי תשלום. עונות על 6 שאלות ומקבלות דוח קצר ומותאם.",
  },
  {
    question: "מה מקבלות אחרי הבדיקה?",
    answer:
      "דוח קצר שמזהה איפה העסק נשען עלייך הכי חזק, מה זה עולה לך ביום-יום, ומה כדאי לסדר קודם. ספציפי לעסק שלך, לא עצות כלליות.",
  },
  {
    question: "כמה זמן זה לוקח?",
    answer:
      "פחות מ-3 דקות. 6 שאלות עם כפתורי בחירה — בלי שדות כתיבה, בלי חישובים.",
  },
  {
    question: "למי הבדיקה מתאימה?",
    answer:
      "לנשים עצמאיות בעסק שירות פעיל שהעסק עובד אבל עדיין נשען עליהן יותר מדי. לא מתאים לעסקים בתחילת הדרך או לארגונים גדולים.",
  },
  {
    question: "מה קורה אם אני לא יודעת להסביר מה הבעיה?",
    answer:
      "זה בדיוק בשביל מה השאלון קיים. לא צריך הגדרה מסודרת. השאלות נוגעות בדברים שאת מרגישה ביום-יום. את עונה, אני מפרשת.",
  },
  {
    question: "צריכה להשאיר מייל?",
    answer:
      "לא. מספיק שם ומספר וואטסאפ. מייל הוא אופציונלי בלבד, אם תרצי עותק נוסף.",
  },
  {
    question: "יש לי כבר מאנדיי, נושן או CRM. מה יחדש לי?",
    answer:
      "כלים בלי תהליך מסודר לרוב מסבכים. הבדיקה בוחנת אם הכלים שיש לך משרתים אותך, או שאת עובדת בשבילם.",
  },
  {
    question: "חייבת להמשיך לשיחת מיפוי?",
    answer:
      "לא. הדוח הקצר עומד בפני עצמו. אם תרצי, נעשה שיחת מיפוי של 20-30 דקות. אם לא, יוצאת עם תמונה ברורה ומיישמת לבד.",
  },
];

const WHY_ME_HEADLINE = "אני רואה תהליכים. הבנתי איפה עסקים נשברים.";
const WHY_ME_INTRO = "עבדתי עם ארגונים ועצמאיות. המשותף תמיד היה אותו דבר: לא חסרים כלים, חסר מבנה שמחזיק. זה מה שאני בונה.";
...
export const HOME_ABOUT_SECTION: WhyMeSectionCopy = {
  ...
  whyMeClose:
    "אם את מרגישה שהעסק עדיין נשען עלייך יותר מדי, השאלון יזהה בדיוק איפה זה קורה ומה כדאי לשנות קודם. בלי התחייבות.",
};
