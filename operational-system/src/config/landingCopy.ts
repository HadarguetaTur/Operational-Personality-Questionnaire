...
export const SHARED_FAQ: FaqItem[] = [
  {
    ...
    answer:
      "לעסקים שעדיין מחפשים \"פתרונות קסם\" בלי לנהל תהליך. אם את לא מוכנה להשקיע זמן בתשתית כדי לקבל חופש אחר כך — חבל על הזמן של שתינו. אני עובדת עם עסקים שרוצים לצמוח, לא עם כאלו שמתמקדים רק בכיבוי שריפות.",
  },
  {
    question: "יש לי כבר מאנדיי, נושן או CRM. מה האבחון יחדש לי?",
    answer:
      "מערכת בלי תהליך היא אוסף יקר של נתונים שלא זז. רוב העסקים שאני פוגשת משתמשים ב־20% מהיכולת של הכלים ומשלמים מחיר מלא בגלל סרבול. האבחון מראה אם הכלי משרת אותך, או שאת עובדת בשבילו.",
  },
  {
    question: "כמה זמן זה דורש ממני?",
    answer:
      "האבחון החינמי באתר לוקח בערך 5 דקות, והתוצאה מגיעה למייל. אם ממשיכות הלאה לעומק — יש איסוף מידע נוסף וסשן של 30 דקות. בפועל, היישום אחרי זה לרוב לוקח פחות זמן מלרדוף אחרי משימות שלא מתקדמות לבד.",
  },
  {
    question: "זה מחייב אותי לתהליך ליווי ארוך?",
    answer:
      "האבחון החינמי לא מחייב שום דבר. גם סשן האפיון מיועד לערך מיידי, לא לנעול אותך לחודשים. אם תרצי שאבנה מערכת — נדבר; אם לא, יש לך מפה ואפשר ליישם לבד.",
  },
  {
    question: "איך קובעים? מה מדיניות ביטול?",
    answer:
      "לסשן משלים (אפיון) קובעים דרך הקישור, בתשלום מראש: ביטול עד 24 שעות לפני המועד — החזר מלא. האבחון החינם באתר לא דורש תשלום.",
  },
  {
    question: 'מה מתקבל אחרי האבחון החינמי?',
    answer:
      "תקבלי תמונה מסודרת של איפה העסק נשען עלייך, מה נתקע, ומה כדאי לטפל בו קודם — בלי התחייבות להמשיך את התהליך.",
  },
];

const WHY_ME_HEADLINE = "את לא צריכה עוד יועצת. את צריכה אדריכלית.";
const WHY_ME_INTRO = "יש הרבה אנשים שיכולים לצייר לך תרשימי זרימה יפים במצגת, ויש הרבה \"אנשי טכני\" שיבנו אוטומציות שיסבכו אותך יותר. אני הגשר ביניהם — מגיעה מהשטח, מהטמעות של מערכות מורכבות בעסקים חיים. אני לא בונה תהליכים \"לפי הספר\", אלא Architecture of Scale: תשתית שנועדה להחזיק כשאת לא בחדר, כשעובד עוזב, או כשהביקוש קופץ פי שלוש. אני לא נותנת לך דגים — אני בונה לך את הצי המכני שדג עבורך.";
const WHY_ME_PROOFS: string[] = [
  ...
  "ניסיון בבניית תשתיות, מהנייר ועד למערכת שעובדת.",
];
...
export const HOME_ABOUT_SECTION: WhyMeSectionCopy = {
  ...
  whyMeClose:
    "אם העסק רגיש אלייך ברגעים הלא נכונים — האבחון החינמי יראה לך איפה זה קורה ומה כדאי לטפל בו קודם. אין התחייבות: רק בהירות כדי להחליט נכון בשלב הבא.",
};
